...
app.get('/lnurl', (req, res) => {
   const metadata = [
       ["text/plain", "TheWildHustle's LNURL-PAY endpoint"]
   ];
   const response = {
       callback: `${process.env.BACKEND_URL}/callback`,
       maxSendable: 1000000000, // milisatoshis
       minSendable: 100,      // milisatoshis
...
app.get('/callback', async (req, res) => {
   ...
   const metadata = [["text/plain", "TheWildHustle's LNURL-PAY endpoint"]];
